...
window.TodosCollection = _todo_collection2['default'];
...
},{"./ajax_setup":1,"./router":3,"./todo_collection":4,"jquery":8}],3:[function(require,module,exports){
'use strict';
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.todos = new _todo_collection2['default']();
  },

  // Create each function
  home: function home() {
    console.log('show home page');
    this.$el.html(_viewsHome2['default']);
  },
...
},{"./todo_collection":4,"./views/home":5,"./views/todos":6,"backbone":7}],4:[function(require,module,exports){
'use strict';
...
var TodosCollection = _backbone2['default'].Collection.extend({
  ...
  // Passes raw response object after collection's model returned by the server (ajax)
...
// Create constructor for collection
'use strict';
